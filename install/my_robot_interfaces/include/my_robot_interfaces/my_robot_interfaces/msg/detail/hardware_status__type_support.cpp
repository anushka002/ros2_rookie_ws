...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HardwareStatus_message_member_array[3] = {
  {
    ...
    offsetof(my_robot_interfaces::msg::HardwareStatus, temp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces::msg::HardwareStatus, motors_ready),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
