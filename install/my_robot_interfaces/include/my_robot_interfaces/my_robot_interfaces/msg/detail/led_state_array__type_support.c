...
static rosidl_typesupport_introspection_c__MessageMember my_robot_interfaces__msg__LedStateArray__rosidl_typesupport_introspection_c__LedStateArray_message_member_array[2] = {
  {
    "led_states",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces__msg__LedStateArray, status),  // bytes offset in struct
    NULL,  // default value
