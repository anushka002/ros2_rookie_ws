...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LedStates_message_member_array[4] = {
  {
    "led1",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces::msg::LedStates, msg),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
